...
http {
    ...
    server {
        ...
        location / {
            root   C:/nginx/projects/project1;
            index  index.html;
        }
    }
    ...
    server {
        ...
        location / {
            root   C:/nginx/projects/project2;
            index  index.html;
        }
    }
...
server {
    ...
    location /images/ {
        alias  C:/nginx/projects/project2/wwwroot/images/;
    }

    location /js/ {
        alias  C:/nginx/projects/project2/wwwroot/js/;
    }
...
http {
    ...
    server {
        ...
        ssl_certificate_key  C:/nginx/conf/ssl/cert.key;
